...
public class MecanumDriveTrain extends Subsystem {
    ...
    private final CANTalon frontLeft = RobotMap.mecanumDriveTrainTalonSRX6; //frontleft
    private final CANTalon rearRight = RobotMap.mecanumDriveTrainTalonSRX2; //rearright
    private final CANTalon frontRight = RobotMap.mecanumDriveTrainTalonSRX7; //frontright
